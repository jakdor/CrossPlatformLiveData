...
{
    /// <summary>
    /// UITableViewController with CrossPlatformLiveData LifecycleManager linked to lifecycle events
    /// </summary>
    public class LiveDataTableViewController : UITableViewController
    {
        ...
        public LiveDataTableViewController()
        {
        }

        public LiveDataTableViewController(IntPtr handle) : base(handle)
        {
        }
