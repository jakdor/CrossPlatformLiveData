...
{
    /// <summary>
    /// UIPageViewController with CrossPlatformLiveData LifecycleManager linked to lifecycle events
    /// </summary>
    public class LiveDataPageViewController : UIPageViewController
    {
        ...
        public LiveDataPageViewController()
        {
        }

        public LiveDataPageViewController(IntPtr handle) : base(handle)
        {
        }
