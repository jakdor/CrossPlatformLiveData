...
{
    /// <summary>
    /// UITabBarController with CrossPlatformLiveData LifecycleManager linked to lifecycle events
    /// </summary>
    public class LiveDataTabBarController : UITabBarController
    {
        ...
        public LiveDataTabBarController()
        {
        }

        public LiveDataTabBarController(IntPtr handle) : base(handle)
        {
        }
