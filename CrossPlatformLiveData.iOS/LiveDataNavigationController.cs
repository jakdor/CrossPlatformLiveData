...
{
    /// <summary>
    /// UINavigationController with CrossPlatformLiveData LifecycleManager linked to lifecycle events
    /// </summary>
    public class LiveDataNavigationController : UINavigationController
    {
        ...
        public LiveDataNavigationController()
        {
        }

        public LiveDataNavigationController(IntPtr handle) : base(handle)
        {
        }
